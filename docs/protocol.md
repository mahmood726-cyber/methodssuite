        # Methodssuite: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/methodssuite.git

        ## Objective

        MethodsSuite is a unified browser-based meta-analysis methods platform integrating Bayesian MA, pooling, meta-regression, pub-bias, and PRISMA checking under a single MAIF schema.
        ...
        - Code: https://github.com/mahmood726-cyber/methodssuite.git
        - Dashboard: https://mahmood726-cyber.github.io/methodssuite/
